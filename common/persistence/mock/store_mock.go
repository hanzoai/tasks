...
//
//	mockgen -package mock -source persistence_interface.go -destination mock/store_mock.go -aux_files github.com/hanzoai/tasks/common/persistence=data_interfaces.go
//
