...
//
//	mockgen -package manager -source visibility_manager.go -destination visibility_manager_mock.go -aux_files github.com/hanzoai/tasks/common/persistence=../../data_interfaces.go
//
