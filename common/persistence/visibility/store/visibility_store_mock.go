...
//
//	mockgen -package store -source visibility_store.go -destination visibility_store_mock.go -aux_files github.com/hanzoai/tasks/common/persistence=../../data_interfaces.go
//
